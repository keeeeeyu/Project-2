...
router.get('/oauth2callback', passport.authenticate(
  'google',
  {
    successRedirect : '/countries', // where do you want the client to go after you login 
    failureRedirect : '/countries' // where do you want the client to go if login fails
  }
));
